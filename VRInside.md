...
## ターゲット
* VR開発をこれから始めようと考えているエンジニア

## 読んだ人がどうなるか
* 自分が開発できるVRコンテンツのイメージがモテるようになる
* サンプルコードを手元で試すことで、VRコンテンツ開発の経験を得られる
* VRがちょっと好きになる！
...
* 事例紹介
	...
	* ヘルスケア
		* 失禁体験 http://kai-you.net/article/28469
	* いろいろな分野で価値を発揮する可能性
* HMDに幾つか種類があるので、それぞれにコンテンツを開発する必要があるという話をする
